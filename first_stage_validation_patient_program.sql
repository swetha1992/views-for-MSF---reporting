SELECT
  ...
  fstbm.id_fstg_specialty_determined_by_mlo,
  fstbm.fstg_specialty_determined_by_mlo

FROM first_stage_validation AS fsv

  JOIN fstg_first_stage_validation AS ffsv
  ...
  JOIN fstg_specialty_determined_by_mlo AS fsdbm
    ON fmf.id_fstg_medical_files = fsdbm.id_fstg_medical_files
